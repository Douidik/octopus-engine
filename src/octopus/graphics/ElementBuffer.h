...
public:
    static Ref<ElementBuffer> Create(const void *data, GLsizei size, GLenum type, GLenum usage = GL_STATIC_DRAW);

    ElementBuffer(const void *data, GLsizei size, GLenum type, GLenum usage);
    ~ElementBuffer();
